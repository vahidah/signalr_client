          ...
          appBar: AppBar(
              ...
              title: InkWell(
                onTap: () => myController.nav.snackBar(
                    Text("contact id is: ${state.selectedChat!.chatId}",
                ...
                child: Row(
                  children: [
                        ...
                        child: state.selectedChat!.image == null
                            ? FittedBox(
                                ...
                                child: Text(
                                  ...
                                  style: GoogleFonts.alegreya(textStyle: const  TextStyle(color: ProjectColors.projectBlue))
                                ),
                              )
                    ...
                    Text(
                      ...
                      style: GoogleFonts.alegreya(textStyle: const  TextStyle(fontSize: 20, color: ProjectColors.fontWhite))
                    ),
                  ],
                ),
              )),
